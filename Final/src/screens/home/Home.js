...
class Home extends Component {
    ...
    genreFiterHandler = event => {
        this.setState({ genres: event.target.value });
    }

    artistsFilterHandler = event => {
        this.setState({ artists: event.target.value });
    }

    releaseDateStartFilterHandler = event => {
        this.setState({ releaseDateStart: event.target.value });
    }

    releaseDateEndFilterHandler = event => {
        this.setState({ releaseDateEnd: event.target.value });
    }

    releasedMovieClickHandler = (movieId) => {
        ...
        return (
            <div>
                ...
                <div className="flex-container">
                    ...
                    <div className="released-movies-cards">
                        <GridList cellHeight={350} cols={4} className={classes.gridListMain}>
                            {this.state.releasedMovies.map(movie => (
                                <GridListTile onClick={() => this.releasedMovieClickHandler(movie.id)} className="marginMovie" key={"grid" + movie.id}>
                                    <img src={movie.poster_url} alt={movie.title} />
                                    <GridListTileBar
                                        title={movie.title}
                            ...
                            <CardContent>
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.genreFilterHandler}>
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.artistsFilterHandler}>
                                ...
                                <FormControl className={classes.formControl}>
                                    <TextField
                                        ...
                                        onChange={this.releaseDateStartFilterHandler}
                                    />
                                </FormControl>
                                ...
                                <FormControl className={classes.formControl}>
                                    <TextField
                                        ...
                                        defaultValue=""
                                        InputLabelProps={{ shrink: true }}
                                        onChange={this.releaseDateEndFilterHandler}
                                    />
                                </FormControl><br /><br />
